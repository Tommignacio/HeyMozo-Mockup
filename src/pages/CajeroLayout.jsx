...
export default function CajeroLayout({
  ...
  return (
    <div className="min-h-screen flex flex-col font-['Inter',sans-serif] text-slate-100" style={{ background: '#11131e' }}>
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            <div
              ...
              style={{ background: 'rgba(19,236,167,0.1)', border: '1px solid rgba(19,236,167,0.2)' }}
            >
            ...
            <div
              ...
              style={{ background: '#1a1d2e', border: '1px solid #2d324a' }}
            >
      ...
      {/* ── Main ── */}
      <main className="mx-auto p-6 lg:p-12 flex-1 w-full">
        {/* Summary bar — two stat cards */}
        <div className="flex flex-wrap gap-4 mb-10" style={{ margin: '2rem' }}>
          <div className="flex-1 min-w-[240px] rounded-2xl flex items-center gap-5" style={{ background: '#1a1d2e', border: '1px solid #2d324a', padding: '1rem' }}>
            <div className="p-3 rounded-xl" style={{ background: 'rgba(19,236,167,0.2)' }}>
        ...
        {/* 12-col grid: 4 + 8 */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10" style={{ margin: '2rem' }}>

          {/* ── Left: Transferencias Pendientes ── */}
          <div className="lg:col-span-4 space-y-6">
            <div className="flex items-center justify-between px-2">
              ...
              {hasPending && (
                <span className="bg-red-500 text-white text-xs font-bold px-2.5 py-1 rounded-full">1</span>
              )}
            </div>
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-3" style={{ padding: '1rem' }}>
                  <button
                    ...
                    style={{ background: '#13eca7', color: '#11131e' }}
      ...
      {/* ── Bottom Nav (mobile only — matches Stitch desktop HTML) ── */}
      <div
        className="fixed bottom-0 w-full lg:hidden flex justify-around px-6 py-4"
        style={{ background: '#1a1d2e', borderTop: '1px solid #2d324a' }}
      >
        <a href="/cajero"><span className="material-symbols-outlined" style={{ color: '#13eca7' }}>dashboard</span></a>
        <a href="/mozo"><span className="material-symbols-outlined text-slate-500">table_bar</span></a>
        <a href="/mozo"><span className="material-symbols-outlined text-slate-500">payments</span></a>
